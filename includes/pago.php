...
//                            $files = array();
//                            $archivo = '../../enlinea/pago/soportes/'. $data["archivo"];
...
//                            }
                            ...
                            if ($r=="") {
                                ...
                                $resultado['mensaje'].='<br>No se pudo enviar el correo de confirmación';
                            }
                            //$r = $mail->enviar_email("Pago de Condominio", $mensaje, "", "aerometro","",$files);
                        }
                    }
                } else {
                ...
                if ($res['data'][0]['estatus']=='a') {
                    $resultado['mensaje'].= "\nEl pago ya fue rechazado. Si considera que es un error nuestro, escríbanos a cavalor1702@gmail.com";
                }
            }
        } catch (Exception $exc) {
            $resultado['suceed'] = false;
